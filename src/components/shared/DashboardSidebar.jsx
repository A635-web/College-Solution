...
const DashboardSidebar = () => {
 ...
 <div className="flex flex-col overflow-x-hidden relative overflow-hidden">



 <div className="flex flex-row relative gap-5 top-0 left-0 float-left w-150px">
